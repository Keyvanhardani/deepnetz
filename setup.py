...
CYTHON_MODULES = [
    ...
    "deepnetz/engine/monitor.py",
    "deepnetz/engine/session.py",
    "deepnetz/engine/scanner.py",
    "deepnetz/engine/evaluator.py",
    "deepnetz/backends/base.py",
    "deepnetz/backends/native.py",
    "deepnetz/backends/ollama.py",
    "deepnetz/backends/vllm.py",
    "deepnetz/backends/lmstudio.py",
    "deepnetz/backends/huggingface.py",
    "deepnetz/backends/remote.py",
    "deepnetz/backends/discovery.py",
    "deepnetz/cache/eviction.py",
    "deepnetz/cache/merging.py",
    "deepnetz/cache/turboquant.py",
    "deepnetz/tools/base.py",
    "deepnetz/tools/search.py",
    "deepnetz/tools/registry.py",
    "deepnetz/ui/routes.py",
